...
|---|---|---|---|---|---|
| Proposition 1 (Frontier expansion) / Section 4.2, Proposition 1, page 15 | `proposition1_frontier_expansionSpec` -> `proposition1_frontier_expansion` | pending | pending | pending | `by sorry` |
| Proposition 2 (Activation band for unfamiliar languages) / Section 4.2, Proposition 2, pages 15-16 | `proposition2_activation_bandSpec` -> `proposition2_activation_band` | pending | pending | pending | `by sorry` |
| Proposition 3 (Dynamic cumulative-language effect) / Section 4.3, Proposition 3, page 17; proof in Appendix A.6, pages 63-64 | `proposition3_dynamic_cumulative_effectSpec` -> `proposition3_dynamic_cumulative_effect` | pending | pending | pending | `by sorry` |
| Proposition 4 (Specialist and ability heterogeneity) / Appendix A.5, Proposition 4, pages 62-63 | `proposition4_specialist_heterogeneitySpec` -> `proposition4_specialist_heterogeneity` | pending | pending | pending | `by sorry` |
| Proposition 5 (Repository expansion) / Appendix A.8, Proposition 5, page 65 | `proposition5_repository_expansionSpec` -> `proposition5_repository_expansion` | pending | pending | pending | `by sorry` |
